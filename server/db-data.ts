export const COURSES: any = {
  ...
  5: {
    ...
    titles: {
      ...
      longDescription:
        'Establish a solid layer of fundamentals, learn whats under the hood of Angular',
    },
    iconUrl:
  ...
  6: {
    ...
    titles: {
      ...
      longDescription:
        'Learn Web Security Fundamentals  / Node Application from multiple types of attacks.',
    },
    iconUrl:
